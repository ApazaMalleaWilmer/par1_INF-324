                ...
                <?php else: ?>
                    <tr>
                        <td colspan="8" class="text-center">
                            ...
                            <br>
                            <a href="eliminar_persona.php?ci=<?php echo $ci; ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta persona?');">Eliminar Persona</a>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
