...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#contacto">Ingresar</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../login/index.php">Ingresar Funcionario</a>
            </li>
        </ul>
    </div>
</nav>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption text-left custom">
                <h5 style="font-size: 9rem; text-align: left;">CALIDAD   DEL   <br><span style="color: skyblue;">AIRE</span>
                </h5>
